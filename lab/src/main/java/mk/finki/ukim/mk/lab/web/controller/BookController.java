...
public class BookController {
    ...
    public String editBook(@PathVariable Long bookId,Model model){
        ...
        model.addAttribute("year", book.getProdYear());
        model.addAttribute("bookStoreId", book.getBookStore());
        return "edit-form";
    }
    @GetMapping("/filteredGenres")
    public String getFilteredAuthors(@RequestParam String genreFilter){
        bookService.filterByGenre(genreFilter);
        return "redirect:/books";
    }
    @GetMapping("/filteredTitles")
    public String getTitleFilter(@RequestParam String titleFilter){
        bookService.filterByTitle(titleFilter);
        return "redirect:/books";
    }
}
